...
/**
 * A custom JUnit4 Runner based on org.opennms.core.test.OpenNMSJUnit4ClassRunner
 *
 * @author <a href="mailto:agalue@opennms.org">Alejandro Galue</a>
 */
public class OnmsTestRunner extends SpringJUnit4ClassRunner {
...
//          "org.opennms.core.collection.test.JUnitCollectorExecutionListener",
    ...
    /**
     * Instantiates a new OpenNMS test runner.
     *
     * @param clazz the class object
     * @throws InitializationError the initialization error
     */
    public OnmsTestRunner(Class<?> clazz) throws InitializationError {
        super(clazz);
