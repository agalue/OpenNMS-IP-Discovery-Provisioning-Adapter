 ...
 */
public class IpDiscoveryTable1Tracker extends IPAddressTableTracker implements IpTableTracker {

    /** The Constant LOG. */
    private static final Logger LOG = LoggerFactory.getLogger(IpDiscoveryTable1Tracker.class);

    /** The discovered IP interfaces. */
    private Set<OnmsIpInterface> discoveredIps = new HashSet<>();

    /* (non-Javadoc)
     * @see org.opennms.netmgt.provision.service.IPAddressTableTracker#processIPAddressRow(org.opennms.netmgt.provision.service.IPAddressTableTracker.IPAddressRow)
     */
    @Override
